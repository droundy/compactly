...
fn size() {
    ...
    use crate::Compact;
    assert_bits!(Compact(0_u64), 8);
    assert_bits!(0_usize, 4);
    assert_bits!(Compact(1_u64), 8);
    assert_bits!(1_usize, 4);
    assert_bits!(Compact(2_u64), 8);
    assert_bits!(2_usize, 4);
    assert_bits!(3_usize, 4);
    assert_bits!(4_usize, 9);
    assert_bits!(5_usize, 9);
    assert_bits!(6_usize, 9);
    assert_bits!(7_usize, 9);
    assert_bits!(8_usize, 10);
    assert_bits!(Compact(16_u64), 11);
    assert_bits!(16_usize, 11);
    assert_bits!(Compact(32_u64), 12);
    assert_bits!(32_usize, 12);
    assert_bits!(Compact(64_u64), 13);
    assert_bits!(64_usize, 13);
    assert_bits!(Compact(128_u64), 14);
    assert_bits!(128_usize, 14);
    assert_bits!(Compact(256_u64), 15);
    assert_bits!(256_usize, 15);
    assert_bits!(512_usize, 16);
    assert_bits!(Compact(1024_u64), 17);
    assert_bits!(1024_usize, 17);
    assert_bits!(Compact(1024_u64 * 1024), 27);
    assert_bits!(1024_usize * 1024, 27);
    assert_bits!(1024_usize * 1024 * 1024, 37);
    assert_bits!(u32::MAX as usize, 39);
    // Note the code will work for u32, but the following two tests will fail.
    assert_bits!(1024_usize * 1024 * 1024 * 1024, 47);
    assert_bits!(1024_usize * 1024 * 1024 * 1024 * 1024, 57);
    assert_bits!([0_usize; 128], 23);
    assert_bits!([1_usize; 19], 14);
    assert_bits!(
