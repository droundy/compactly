...
impl BitContext {
    ...
    pub const fn adapt(self, bit: bool) -> Self {
        // A `static`, not a `const`: indexed at runtime from hot code, and a
        // promoted `const` may be duplicated per codegen unit.
        static OUTCOMES: [BitContext; 2 * 679] = [
            ...
            True66False1,  // from True66False0 with false
            ...
            True66False0,  // from True133False0 with false
            ...
            True33False1,  // from True66False1 with false
            ...
            True1False66,  // from True1False65 with false
            True0False67,  // from True0False66 with false
            True0False33,  // from True1False66 with false
            ...
            True0False133, // from True0False132 with false
            True0False133, // from True0False133 with false
            ...
            True133False0, // from True132False0 with true
            True133False0, // from True133False0 with true
            ...
            True66False1,  // from True65False1 with true
            True33False0,  // from True66False1 with true
            ...
            True1False66,  // from True0False66 with true
            True1False33,  // from True1False66 with true
            ...
            True0False66,  // from True0False133 with true
        ];
        OUTCOMES[(self as usize) + (bit as usize) * 679]
    }
}
