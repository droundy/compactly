...
fn btreeset() {
    ...
    expect!["161"].assert_eq(&encoded_bits!(BTreeSet::from_iter(
...
fn compact_btreeset() {
    ...
    expect!["125"].assert_eq(&encoded_bits!(Encoded::<_, Small>::new(
        BTreeSet::from_iter(0_u64..1024)
    )));
    expect!["144"].assert_eq(&encoded_bits!(Encoded::<_, Small>::new(
