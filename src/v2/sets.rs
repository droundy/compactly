...
fn btreeset() {
    ...
    assert_bits!(BTreeSet::from_iter(1_000_000_u64..1_001_024), 161);
    assert_bits!(BTreeSet::from_iter(2_000_000_u64..2_002_048), 245);
    assert_ans_bits!(BTreeSet::from_iter(2_000_000_u64..2_002_048), 245);
}
