...
fn size() {
    ...
    expect!["normal: 8980 bits, small: 7113 bits"]
    ...
    expect!["normal: 412 bits, small: 419 bits"].assert_eq(&compare_small_bits(
        "This sentence is pretty long and seems reflective of ordinary English to me.",
    ));
    expect!["normal: 1538 bits, small: 835 bits"].assert_eq(&compare_small_bits(
        "This sentence is pretty long and seems reflective of ordinary English to me.
           If I duplicate this sentence then I should get better compression, right?
           This sentence is pretty long and seems reflective of ordinary English to me.
           If I duplicate this sentence then I should get better compression, right?",
    ));
    expect!["normal: 1608 bits, small: 1005 bits"].assert_eq(&compare_small_bits(
        "This sentence is pretty long and seems reflective of ordinary English to me.
           If I duplicate this sentence then I should get better compression, right?
    ...
    expect!["normal: Millibits(76817) (77 bits), small: Millibits(82841) (83 bits)"]
        .assert_eq(&compare_vecs(&["hello world"]));
    expect!["normal: Millibits(128147) (128 bits), small: Millibits(101770) (102 bits)"]
        .assert_eq(&compare_vecs(&["hello world", "hello world"]));
    expect!["normal: Millibits(172402) (173 bits), small: Millibits(112584) (113 bits)"].assert_eq(
        &compare_vecs(&["hello world", "hello world", "hello world"]),
    );
    expect!["normal: Millibits(262347) (262 bits), small: Millibits(145803) (146 bits)"].assert_eq(
        &compare_vecs(&[
            "hello world",
            "hello world",
            "hello world",
    ...
    expect!["normal: Millibits(209985) (210 bits), small: Millibits(198370) (198 bits)"]
        .assert_eq(&compare_vecs(&["hello world! 😊", "goodbye world! 😊"]));
    expect!["normal: Millibits(424446) (425 bits), small: Millibits(350885) (351 bits)"].assert_eq(
        &compare_vecs(&[
            "hello world! 😊",
            "greetings world! 😊",
            "goodbye world! 😊",
    ...
    expect!["normal: Millibits(495866) (496 bits), small: Millibits(413459) (414 bits)"].assert_eq(
        &compare_vecs(&[
