...
fn fancy_enum() {
    ...
    assert_bits!(B::A { age: 51 }, expect!["v1: 65 bits, v2: 14 bits"]);
...
fn low_cardinality() {
    ...
    assert_bits!(Data { value: 51 }, expect!["v1: 65 bits, v2: 14 bits"]);
    assert_bits!(
        Data { value: u64::MAX },
    ...
    assert_bits!(
        ...
        expect!["v1: 8379 bits, v2: 8282 bits"]
    );
    ...
    assert_bits!(
        (0..1024)
            ...
            .collect::<Vec<_>>(),
        expect!["v1: 1903 bits, v2: 1795 bits"]
    );
}
