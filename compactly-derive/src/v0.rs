...
pub(crate) fn derive_compactly(mut s: synstructure::Structure) -> proc_macro2::TokenStream {
    ...
    let discriminant_type = quote! { compactly::v0::URange<#num_variants> };
    ...
    let encode_discriminant = s.each_variant(|variant| {
        ...
        quote! {
            compactly::v0::URange::<#num_variants>::new(#discriminant).encode(writer, &mut ctx.discriminant)?;
        }
    });
    ...
    s.gen_impl(quote! {
        ...
        use compactly::v0::{Encode, EncodingStrategy};
        use compactly::{Small, LowCardinality, Decimal, Compressible, Mapping, Normal, Sorted};
        ...
        gen impl Encode for @Self {
            ...
            fn encode<W: std::io::Write>(
                &self,
                writer: &mut compactly::v0::Writer<W>,
            ...
            fn decode<R: std::io::Read>(
                reader: &mut compactly::v0::Reader<R>,
                ctx: &mut Self::Context,
